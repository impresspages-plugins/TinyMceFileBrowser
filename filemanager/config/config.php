...
$application->init();
$application->prepareEnvironment(array('skipErrorHandler' => 1));


if (empty($_SESSION['backend_session']['userId'])) {
...
$base_url = substr(ipConfig()->baseUrl(), 0, -1);  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/../../../file/manual/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../file/manual/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../file/manual-thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
